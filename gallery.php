...
<div class="space-medium">
  <div class="container-fluid">
    <div class="row">
      <h1 class="text-danger" style="margin-left: 1%; padding: 3%; text-transform: uppercase;">Image Gallery</h1>
          <?php 
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="service-block mb60 outline">
              <div class="service-img"> <img style="height: 300px" src="<?php echo $galaryimage_src; ?>" class="img-responsive" alt=""> </div>
            </div>
          </div>
          <?php   $count++; } ?>
    </div>
