                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. <?php echo $today; ?></div>
                                        </div>
                                        <div class="col-auto">
                                        ...
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                ...
                                                <?php 
                                                      ...
                                                      ?>
                                                Earnings (Annual)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rs. <?php echo $year; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                               ...
                                               <!--      <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                            style="width: <?php echo $customers; ?>%" aria-valuenow="50" aria-valuemin="0"
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                ...
                                                Pending Appinments</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $appinment; ?></div>
                                        </div>
                                        <div class="col-auto">
