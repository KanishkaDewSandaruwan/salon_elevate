    ...
    <div class="row">
      <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
        <div class="hero-caption">
          <h1 class="hero-title"><?php echo $row['header_title']; ?></h1>
          <p class="hero-text text-danger"><?php echo $row['header_desc']; ?></p>
          <a href="service.php" class="btn btn-default">MAKE APPOINMENT</a> </div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
            <div class="service-block mb60 outline">
              ...
              <div class="ml-3" style="margin-bottom: 20px; margin-left: 10px"><button type="button" onclick="window.location.href = 'appinment.php?service_id=<?php echo $row3['service_id'] ?>'" class="btn btn-info btn-lg">Make Appinment</button><p style="color: red; font-weight: bold; font-size: 30px; padding: 1%">Rs. <?php echo $row3['price']; ?></p> <?php echo $row3['hour']; ?> Hour</p></div>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
        <div class="about-img"><img src="<?php echo $image_src2; ?>" class="img-responsive" alt=""></div>
      </div>
